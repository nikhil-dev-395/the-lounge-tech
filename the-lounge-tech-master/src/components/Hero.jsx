...
const Hero = () => {
  return (
    <>
      <section className="w-full h-auto pt-7 px-4 sm:px-8 md:px-16 lg:px-20 relative">
        {" "}
        <>
          <StarIcon top={80} bottom={40} left={200} right={20} width={60} />
          <StarIcon top={400} bottom={40} left={1200} width={60} right={0} />
        </>
        {/* Added bg-[#2F20C8] here */}
        {/* Subtitle */}
        ...
        >
          ...
          <ButtonSecond src="/" name="get in touch" />
        </div>
      </section>
    </>
  );
